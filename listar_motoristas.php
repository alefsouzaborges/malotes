		...
		<div class="row justify_row justify-content-center" >
			<div class="box-form-listar-usuarios">
				...
				<table class="table table-sm table-striped table-hover table-light " style="color: #000; border-radius: 5px;">
				  ...
				  <tbody>
				  	<?php foreach($sqlMotorista->fetchAll() as $dados):  ?>
					  <tr>
				      <td align="center"><a href="alterar_motoristas.php?id=<?php echo $dados['id']; ?>"><?php echo $dados['id']?></a></td>
				      <td><a href="alterar_motoristas.php?id=<?php echo $dados['id']; ?>"><?php echo $dados['nome']?></a></td>
				      <td><a href="alterar_motoristas.php?id=<?php echo $dados['id']; ?>"><?php echo $dados['telefone']?></a></td>
				  	<?php endforeach; ?>
				  </tbody>
				</table>
