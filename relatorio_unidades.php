		...
		<div class="row justify_row justify-content-center" >
			<div class="box-form-listar-usuarios">	
				<table class="table table-sm table-striped table-hover table-light " style="color: #000; border-radius: 5px;">
					<form action="classes/pdf_unidades.php" target="_blank" method="POST" >
				  <thead>
				  ...
				  <tbody>
				      ...
				      <td><a href=""><?php echo $dados['cnpj']?></a></td>
				      <td><a href=""><?php echo $dados['razaosocial']?></a></td>
				      <td><a href=""><?php echo $dados['uf']?></a></td>
				      <td><a href=""><?php echo $dados['cidade']?></a></td>
				      <td><a href=""><?php echo $dados['endereco']?></a></td>
				      <td><a href=""><?php echo $dados['numero']?></a></td>
				  	<?php endforeach; ?>
				  </tbody>
				</table>
				<div class="row justify-content-end mr-0">
					<button class="btn btn-primary">Gerar Relatório</button>
					<form action="pdf_usuarios.php" target="_blank" method="POST" >
				</div>
		</body>
	</body>
	</html>
